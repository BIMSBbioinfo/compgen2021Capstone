...
start these are possibly viable options. - use SVD, find eigenvectors associated
with batch class, remove them and reconstruct data. - use linear regression to
remove effects example:
https://rdrr.io/github/LTLA/batchelor/man/rescaleBatches.html or
https://rdrr.io/github/LTLA/batchelor/man/regressBatches.html - use single-cell
