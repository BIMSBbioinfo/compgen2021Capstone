...
3. Take the best model from sub-task 1 and also the combine the models models in
...
technical differences due to data acquisition and processing exists. These
...
start these are possibly viable options. 
    - use SVD, find eigenvectors associated with batch class, remove them and
reconstruct data.
    - use linear regression to remove effects example:
...
https://rdrr.io/github/LTLA/batchelor/man/regressBatches.html 
    - use single-cell RNA-seq methods that uses mutual-nearest neighbours to correct
for batch effects: https://rdrr.io/github/LTLA/batchelor/man/fastMNN.html
