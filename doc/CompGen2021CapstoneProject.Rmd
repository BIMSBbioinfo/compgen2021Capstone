...
author:   İrem Begüm, Bora Uyar, Vedran Franke, Jan Dohmen, Artem Baranovsky, Altuna Akalin
  Gündüz
Date: "`r Sys.Date()`"
output:
  html_document:
...
Hands-on Data Analysis 2021: Machine Learning for Genomics!  The main aim of the tasks is
to predict the response of 6 oncology drugs on different disease models.
...
of `CMA` data which stands for `Cell-Line Microrray`. Cell lines are the tumor
samples that are grown in the lab environment. Cell lines are poor representations of
...
0. Check if you need some sort of normalization, scaling or data processing. More complicated
methods for batch effect correction is on Task 3 and doesn't belong in this task.
