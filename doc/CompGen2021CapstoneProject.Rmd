...
## 3. TASK 1: use multi-omics data to predict drug response
...
on the other two? For example, for a given drug say Cetuximab, apply the CCLE model on GDSC_Sanger model [MORE HERE]

3. Take the best model from sub-task 1 and also the combine the models models in an ensemble earner or simply average their output and
predict drug response on `the PDX data set`. Plot the metrics (R-squared, Pearson correlation and Spearman's Correlation) for observed vs predicted efficacy of each drug. Did the simple model [MORE HERE]
...
* Anything is OK but not everything will be performant. 
...
### Summary of Data to be Used in Part I Tasks 
...
## 5. TASK 2: Predict drug response using panel sequencing data.
...
### Summary of Data to be Used in Part II Tasks
